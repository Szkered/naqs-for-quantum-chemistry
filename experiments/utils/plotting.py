...
def plot_vmc(vmc, molecule, title=""):
  ...
  with plt.style.context('seaborn-paper', after_reset=True):
    ...
    ax1.axhline(
      molecule.fci_energy - zero_level,
      0,
      1,
      ls='--',
      color='k',
    ...
    ax1.axhline(
      molecule.fci_energy + chem_acc - zero_level,
      0,
      1,
      ls='--',
      color='g',
    ...
    ax2.axhline(
      molecule.fci_energy + chem_acc + offset,
      0,
      1,
      ls='--',
      color='g',
